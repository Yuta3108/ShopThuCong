                ...
                <div className="lg:col-span-9 mt-6 lg:mt-0">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                        <h2 className="text-lg sm:text-xl font-semibold text-pink-600">
                            Tất cả sản phẩm
                            <span className="text-gray-500 ml-2">({filteredProducts.length} sản phẩm)</span>
                        </h2>
                    ...
                    {totalPages > 1 && (
                        <div className="flex justify-center items-center gap-2 mt-8 flex-wrap">
                            <button
                                ...
                                disabled={safePage === 1}
                                className={`px-3 py-1.5 text-sm rounded-md border ${safePage === 1 ? "text-gray-400 border-gray-200 cursor-not-allowed" : "text-gray-700 border-gray-300 hover:bg-gray-100"}`}
                            >
                                Trước
                            </button>
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm rounded-md border ${safePage === totalPages ? "text-gray-400 border-gray-200 cursor-not-allowed" : "text-gray-700 border-gray-300 hover:bg-gray-100"}`}
                            >
                                Sau
                            </button>
                        </div>
