        ...
        <main className="flex-1">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-10">
              {KPIS.map((kpi, i) => (
                <KPIcard key={i} title={kpi.title} value={kpi.value} badge={kpi.badge} />
              ))}
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm h-[340px]">
              ...
              <div className="flex flex-col gap-4 text-sm text-slate-700">
                <div className="flex justify-between">
                  <span>Bộ kim chỉ mini</span>
                  <span className="font-semibold">524 sp</span>
                </div>

                <div className="flex justify-between">
                  <span>Thước đo len</span>
                  <span className="font-semibold">312 sp</span>
                </div>

                <div className="flex justify-between">
                  <span>Kéo cắt giấy</span>
                  <span className="font-semibold">280 sp</span>
                </div>
              </div>
            </div>
